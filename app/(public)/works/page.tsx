        ...
        <main className="mx-auto max-w-4xl px-6 py-10">
          <div className="flex justify-center items-center min-h-[calc(100vh-120px)]">
            ...
            <div className="w-full max-w-md bg-pink-400 rounded-2xl p-8 shadow-2xl">
              ...
              {/* Name */}
              <h2 className={`${inter.className} text-center text-2xl md:text-3xl font-bold text-white mb-6`}>
              ...
              <div className="space-y-3 mb-8 text-center">
                ...
                <p className="text-white text-base md:text-lg">Jakarta, 13 November 2019</p>
                <p className="text-white text-base md:text-lg">Email : AkuSakhaMakarim13@gmail.com</p>
                <p className="text-white text-base md:text-lg">Nomor : 082255555555555</p>
              </div>
