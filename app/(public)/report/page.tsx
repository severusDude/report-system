        ...
        <header className="sticky top-0 z-30 bg-white/30 backdrop-blur-sm">
          <div className="mx-auto relative flex max-w-7xl items-center justify-between gap-4 px-6 py-4">
            ...
            <nav className="hidden md:flex absolute left-1/2 transform -translate-x-1/2 items-center gap-6">
              ...
              <Link href="/report" className="text-sm font-medium text-[#5BB29D]">Report</Link>
            </nav>
            <div className="flex items-center gap-3">
      ...
      <div className="flex flex-col lg:flex-row gap-6 mx-auto max-w-7xl px-6 py-8">
          ...
          <div className="bg-[#5BB29D]/90 backdrop-blur-sm rounded-2xl p-6 text-white">
            ...
            <div className="space-y-4 mb-6">
              <div className="flex items-center justify-between bg-white/20 rounded-lg p-3">
                ...
                >
                  <option value="" className="text-[#5BB29D]">-</option>
                  {[1, 2, 3, 4, 5, 6].map((kelas) => (
                    <option key={kelas} value={kelas.toString()} className="text-[#5BB29D]">
                      {kelas}
                    </option>
                  ))}
                </select>
              ...
              <div className="flex items-center justify-between bg-white/20 rounded-lg p-3">
                ...
                >
                  <option value="" className="text-[#5BB29D]">-</option>
                  <option value="1" className="text-[#5BB29D]">1</option>
                  <option value="2" className="text-[#5BB29D]">2</option>
                </select>
              </div>
            </div>
        ...
        <main className="flex-1 space-y-6">
          ...
          <div className="bg-gray-100/90 backdrop-blur-sm rounded-xl p-6">
            {/* General Studies */}
            <div className="mb-6">
              <h3 className={`${inter.className} text-[#5BB29D] text-lg font-bold mb-4`}>General Studies</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {generalStudies.map((subject) => (
                  <div key={subject} className="flex justify-between items-center">
                    <p className="text-gray-700">{subject}</p>
                    {selectedKelas && selectedSemester && nilaiGeneral[subject] && (
                      <span className="text-[#5BB29D] font-bold">{nilaiGeneral[subject]}</span>
                    )}
                  </div>
                ))}
              </div>
            ...
            <div className="mb-6">
              <h3 className={`${inter.className} text-[#5BB29D] text-lg font-bold mb-4`}>Al-Qur'an & Islamic Studies</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                {islamicStudies.map((subject) => (
                  <div key={subject} className="flex justify-between items-center">
                    <p className="text-gray-700">{subject}</p>
                    {selectedKelas && selectedSemester && nilaiIslamic[subject] && (
                      <span className="text-[#5BB29D] font-bold">{nilaiIslamic[subject]}</span>
                    )}
                  </div>
                ))}
              </div>
            ...
            <div className="flex gap-4 mt-6">
              ...
              <Link href="/works/student" className="bg-blue-500 text-white font-semibold py-2 px-6 rounded-lg hover:bg-blue-600 transition-colors text-center">
                Lihat Detail Nilai
              </Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Behavior Section */}
            <div className="bg-gray-100/90 backdrop-blur-sm rounded-xl p-6">
              <h3 className={`${inter.className} text-[#5BB29D] text-lg font-bold mb-4`}>Sikap & Perilaku</h3>
              {/* Bar Chart */}
              <div className="space-y-2 mb-4">
                <div className="relative">
                  <div className="flex-1 bg-gray-200 rounded-full h-8 relative overflow-hidden">
                    <div className="bg-blue-500 h-8 rounded-full flex items-center" style={{ width: '60%' }}>
                      <span className="text-white text-sm font-medium pl-3">senyum</span>
                    </div>
                  </div>
                </div>
                <div className="relative">
                  <div className="flex-1 bg-gray-200 rounded-full h-8 relative overflow-hidden">
                    <div className="bg-blue-500 h-8 rounded-full flex items-center" style={{ width: '75%' }}>
                      <span className="text-white text-sm font-medium pl-3">sapa</span>
                    </div>
                  </div>
                </div>
                <div className="relative">
                  <div className="flex-1 bg-gray-200 rounded-full h-8 relative overflow-hidden">
                    <div className="bg-blue-500 h-8 rounded-full flex items-center" style={{ width: '90%' }}>
                      <span className="text-white text-sm font-medium pl-3">salam</span>
                    </div>
                  </div>
                </div>
                <div className="relative">
                  <div className="flex-1 bg-gray-200 rounded-full h-8 relative overflow-hidden">
                    <div className="bg-blue-500 h-8 rounded-full flex items-center" style={{ width: '78%' }}>
                      <span className="text-white text-sm font-medium pl-3">sopan</span>
                    </div>
                  </div>
                </div>
                <div className="relative">
                  <div className="flex-1 bg-gray-200 rounded-full h-8 relative overflow-hidden">
                    <div className="bg-blue-500 h-8 rounded-full flex items-center" style={{ width: '82%' }}>
                      <span className="text-white text-sm font-medium pl-3">santun</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Attendance Section */}
            <div className="bg-gray-100/90 backdrop-blur-sm rounded-xl p-6">
              <h3 className={`${inter.className} text-[#5BB29D] text-lg font-bold mb-4`}>Presensi</h3>
          ...
          <div className="bg-gray-100/90 backdrop-blur-sm rounded-xl p-6">
            <h3 className={`${inter.className} text-[#5BB29D] text-lg font-bold mb-4`}>Catatan Siswa:</h3>
            <p className="text-gray-700 text-sm leading-relaxed">
              Ananda menunjukkan perkembangan yang sangat baik selama di semester ini. Hafalan surat-surat pendek semakin lancar dan konsisten dalam setiap evaluasi. Nilai pelajaran agama juga pelajaran umum juga tercapai dengan seimbang, menggambarkan usaha belajar yang stabil. Sikap dan tanggung jawab Ananda turut mendukung keberhasilan proses belajar sehari-hari. Perkembangan sosialnya juga tampak positif dalam kerja sama kelompok dan menjaga komunikasi baik.
            </p>
          </div>
        </main>
      </div>
